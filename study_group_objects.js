...
let railsSection = [
    ...
    {
        categories: ['Rails URL Helpers', 'Rails form_tag', 'Create Action', 'Index, Show, New, Create Lab', 'Edit/Update Action', 'form_for on Edit', 'Rails Generator', 'Rails Blog Scaffold'],
    ...
    },
    {
        categories: [''],
        title: `${cohort} Open Office Hours`, 
        description: 'Bring your questions and we will learn doing some group coding.',
        day: day2,
        time: time2,
        weekToStart: studygroupWeeks[1],
        weekToEnd: studygroupWeeks[1],
